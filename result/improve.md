...
```
python3 Train.py --method pred --lr 1e-4 --dataset_type ped2 & L1Loss
...
```
python3 Train.py --method pred --lr 1e-4 --dataset_type ped2
...
-----------------------------------------------------------------------------
python3 Evaluate.py --method pred --dataset_type ped2 --model_dir ./exp/ped2/pred/log/ped2_prediction_model.pth --m_items_dir ./exp/ped2/pred/log/ped2_prediction_keys.pt
...
-----------------------------------------------------------------------------
python3 Evaluate.py --method pred --dataset_type ped2 --t_length 6 --model_dir ./exp/ped2/pred/log/ped2_prediction_model.pth --m_items_dir ./exp/ped2/pred/log/ped2_prediction_keys.pt
...
```
python3 Train.py --method pred --msize 9 --t_length 6 --dataset_type ped2
